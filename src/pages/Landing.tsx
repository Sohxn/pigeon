    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-muted-foreground text-lg mb-12 max-w-xl mx-auto">
          ...
          Multiple accounts, unified inbox, intelligent organization.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-16">
          ...
          <div className="border-2 border-foreground rounded-lg p-6 text-left relative">
            ...
            <p className="text-2xl font-bold mb-4">
              $5<span className="text-sm text-muted-foreground font-normal">/mo</span>
            </p>
            <ul className="text-sm text-muted-foreground space-y-2 mb-6">
              <li>• Unlimited email accounts</li>
              <li>• 15GB storage</li>
              <li>• AI organization (coming soon)</li>
            </ul>
            <button
              onClick={() => navigate("/signup")}
          ...
          <div className="border border-border rounded-lg p-6 text-left hover:border-foreground/50 transition-colors">
            ...
            <p className="text-2xl font-bold mb-4">
              $29<span className="text-sm text-muted-foreground font-normal">/mo</span>
            </p>
            <ul className="text-sm text-muted-foreground space-y-2 mb-6">
